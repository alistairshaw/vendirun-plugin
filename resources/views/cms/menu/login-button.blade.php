...
@else
    <li><a href="{{ route(\AlistairShaw\Vendirun\App\Lib\LocaleHelper::getLanguagePrefixForLocale(App::getLocale()) . 'vendirun.register') }}">{{ trans('vendirun::standard.login') }}</a></li>
@endif