...
// blog
Route::group(['namespace' => 'AlistairShaw\Vendirun\App\Http\Controllers\Blog', 'prefix' => 'blog'], function ()
{
    Route::get('/', ['as' => 'vendirun.blog', 'uses' => 'PostController@index']);
    Route::get('search', ['as' => 'vendirun.search', 'uses' => 'PostController@search']);
