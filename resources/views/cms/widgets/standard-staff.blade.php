    ...
    <div class="staff">
        <div class="row">
            @foreach($staff as $person)
                <div class="col-sm-3">
                    <a href="{{ route(\AlistairShaw\Vendirun\App\Lib\LocaleHelper::getLanguagePrefixForLocale(App::getLocale()) . 'vendirun.staff',[$person->id, urlencode($person->first_name)]) }}" class="staff-item">
                        <div class="photo">
