@extends('vendirun::emails.failures.layout')
@section('content')
    <table width="600" border="0" cellpadding="0" cellspacing="0" style="width: 600px;">
        <tr>
            <td width="40" align="left" valign="top">&nbsp;</td>
            <td width="520" align="center" valign="top" style="font-family: 'Century Gothic', Arial, sans-serif; color: #4c4d4f; font-size: 30px;">Contact Form Submission</td>
            <td width="40" align="left" valign="top">&nbsp;</td>
        </tr>
        <tr>
            <td width="40" align="left" valign="top">&nbsp;</td>
        ...
        <tr>
            ...
            <td width="520" align="left" valign="top" style="font-family: 'Century Gothic', Arial, sans-serif; color: #4c4d4f; font-size: 14px;">
                <p>A contact form has been submitted on your website.</p>
            </td>
            <td width="40" align="left" valign="top">&nbsp;</td>
        </tr>
    </table>
